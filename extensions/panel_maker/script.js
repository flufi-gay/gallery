// Name: Panel Maker
// Author: Flufi
// Description: Extension for making (json) panels
// Version: 1.0
...
(function(Scratch) {
	...
	const capCol = v => Math.min(Math.max(v,0),1);
    ...
    const getTintColor = (layers) => layers.reduce((acc, p) => [acc[0] * p.r,acc[1] * p.g,acc[2] * p.b], [1,1,1]);
